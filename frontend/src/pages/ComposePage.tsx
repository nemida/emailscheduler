  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="flex items-center justify-between px-6 py-3.5 border-b border-gray-100">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-sm font-semibold text-gray-800 hover:text-green-600 transition-colors group"
        >
      ...
      <div className="max-w-2xl mx-auto px-6 py-6 flex flex-col gap-0">
        ...
        <div className="flex items-center gap-4 py-3 border-b border-gray-100">
          ...
          <div className="flex-1 flex flex-wrap items-center gap-1.5 min-w-0">
            ...
            {overflowCount > 0 && !showAllRecipients && (
              <span
                onClick={() => setShowAllRecipients(true)}
                className="inline-flex items-center px-2.5 py-0.5 rounded-full border border-green-300 text-xs text-green-600 font-medium cursor-pointer hover:bg-green-50 transition-colors"
              >
                +{overflowCount}
              </span>
            )}
            {showAllRecipients && recipients.length > 3 && (
              <span
                ...
                className="inline-flex items-center px-2.5 py-0.5 rounded-full border border-gray-200 text-xs text-gray-400 font-medium cursor-pointer hover:bg-gray-50 transition-colors"
              >
                show less
              </span>
            )}
